...
`,
                        ...
                        <GridBlock
                            ...
                            contents={[
                            {
                                ...
                                content: 'Agio uses Express to provide rounting, but brings a simplified way to code routes with decorators that represent HTTP verbs and build handler.'
                            },
                            {
                                title: 'Validators',
                                content: 'Write validations for requests using javascript object to build validator schemas. They will be validated using Joi.'
                            },
                            {
                                title: 'Databases',
                                content: 'With Agio you can code models for MongoDB and many SQL database, agio uses _Mongoose_ and _Sequelize_ and the models can be injected using decorators.'
                            },
                        ]}/>

                        <div className="powered-by">
                            <h2>Powred by community</h2>
